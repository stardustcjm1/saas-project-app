class ProjectsController < ApplicationController
  ...
  def add_user
    ...
    respond_to do |format| 
      if @project_user.save
        format.htmo { redirect_to users_tenant_project_url(id: @project.id, tenant_id: @project.tenant_id), notice: "User was successfully added to project" }        
      else
  ...
  private
    ...
    def verify_tenant
      ...
      redirect_to :root, flash: { error: 'Your are not authorized to access any organization other than your own'}
      end
    end
end
